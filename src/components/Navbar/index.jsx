    ...
    return (
        <>
            <nav>
                ...
                <div className={`options-mobile ${hamburgerToggled ? 'options-shown' : ''}`}
                     onClick={() => setHamburgerToggled(p => !p)}>
            ...
            <div className={`mobile-menu-wrapper ${hamburgerToggled ? 'mobile-menu-shown' : ''}`}
                 onClick={onClickMobileMenuOutside}>
                <div className="mobile-menu-content">
                    ...
                    <div className="post_a_message" onClick={() => {
                        setHamburgerToggled(false);
                        onClickCreate()
                    }}>Post a message
                    </div>
